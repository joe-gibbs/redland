...
const items = {
    ...
    "mapPiece1": new Item('Map Piece 1', './assets/img/map_piece1.png'),
    "mapPiece2": new Item('Map Piece 2', './assets/img/map_piece2.png'),
    "mapPiece3": new Item('Map Piece 3', './assets/img/map_piece3.png'),
